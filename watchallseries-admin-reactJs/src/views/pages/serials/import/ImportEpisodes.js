...
class ImportEpisodes extends React.Component {
    ...
    componentDidMount() {
        ...
        SerialsController.importList("swatchseries/serie/" + this.props.match.params.slug).then(data => {
            console.log(data)
            this.setState({ isLoading: true, episodes: data.episodes })
        })
    }
